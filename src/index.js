...
/*
 ...
 Пример:
   removeListener('click', document.querySelector('a'), someHandler) // должна удалить указанный обработчик кликов
...
function once(target, fn) {
    let fn1 = function fnClick() {
        fn();
        target.removeEventListener('click', fnClick)
    }

    target.addEventListener('click', fn1)
}
